...
풀스택 개발자입니다. 프론트엔드와 백엔드를 함께 설계/구현하며, 동작하는 제품을 빠르게 만드는 데 집중합니다.

## Education

- **한국공학대학교 컴퓨터공학과** (2025.03 ~ 현재, 편입)
- **배화여자대학교 컴퓨터공학과** (2023.03 ~ 2025.02, 졸업)
...
- **소프트웨어개발 L5 (NCS 국가직무능력표준)** | 한국산업인력공단
- **정보처리산업기사** | 한국산업인력공단
